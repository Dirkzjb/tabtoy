...
const (
	...
	DataSheetHeader_FieldPerm = 2 // 字段权限
	...
	if verticalHeader {
		...
		for sheet.Row = 1; ; sheet.Row++ {
			...
			he := &DataHeaderElement{
				...
				FieldPerm: sheet.GetCellData(sheet.Row, DataSheetHeader_FieldPerm),
		...
		for sheet.Column = 0; ; sheet.Column++ {
			...
			he := &DataHeaderElement{
				...
				FieldPerm: sheet.GetCellData(DataSheetHeader_FieldPerm, sheet.Column),
