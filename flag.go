...
var (
	...
	paramPbtServerOut    = flag.String("pbt_server_out", "", "output server proto text format (*.pbt)")
	paramPbtClientOut    = flag.String("pbt_client_out", "", "output client proto text format (*.pbt)")
	...
	paramCSharpServerOut = flag.String("csharp_server_out", "", "output server c# class and deserialize code (*.cs)")
	paramCSharpClientOut = flag.String("csharp_client_out", "", "output client c# class and deserialize code (*.cs)")
	paramGoOut           = flag.String("go_out", "", "output golang code (*.go)")
	paramGoServerOut     = flag.String("go_server_out", "", "output server golang code (*.go)")
	paramGoClientOut     = flag.String("go_client_out", "", "output client golang code (*.go)")
	paramBinaryOut       = flag.String("binary_out", "", "output binary format(*.bin)")
	paramBinaryServerOut = flag.String("binary_server_out", "", "output server binary format(*.bin)")
	paramBinaryClientOut = flag.String("binary_client_out", "", "output client binary format(*.bin)")
